...
class _HabitsListScreenState extends State<HabitsListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final dates = List<DateTime>.generate(7, (i) => today.add(Duration(days: i)));
    ...
    return Scaffold(
      appBar: CustomAppBar(
        ...
        trailing: IconButton(
          ...
          onPressed: () async {
            final newHabit = await Navigator.pushNamed(context, AddHabitScreen.routeName);
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return HabitCard(
                              ...
                              color: habit['color'] ?? Colors.indigo,
                              daysCompleted:
                                  habit['daysCompleted'] as List<bool>? ??
